...
namespace BuildReportTool
{
 ...
 PlayerSettings.bundleIdentifier; // ("Bundle Identifier" in iOS, "Package Identifier" in Android)
		...
		public static void PopulateBigConsoleGen08Settings(UnityBuildSettings settings)
		{
            ...
            // ---------------------------------------------------------------
            // XDK Xbox One platform removed in newer Unity versions
            settings.XboxOneDeployMethod = "N/A"; // EditorUserBuildSettings.xboxOneDeployMethod removed

            settings.XboxOneStreamingInstallLaunchRange = 0; // EditorUserBuildSettings.streamingInstallLaunchRange removed
